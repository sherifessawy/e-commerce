...
function useHover() {
    ...
    useLayoutEffect(() => { //used useLayoutEffect because of bug i ran into when i used useEffect see "https://reactjs.org/blog/2020/08/10/react-v17-rc.html#effect-cleanup-timing"
